...
public class StreamFinalEx {
    public static void main(String[] args) {
        ...
        TravelCustomer customerB = new TravelCustomer("장원영", 20, 100);
        TravelCustomer customerC = new TravelCustomer("백종원", 50, 80);
        List<TravelCustomer> customerList = new ArrayList<>();
        customerList.add(customerA);
        customerList.add(customerB);
        customerList.add(customerC);
        customerList.add(new TravelCustomer("민지", 18, 90));
        System.out.println("=".repeat(10) + "고객 명단 순서대로 출력" + "=".repeat(10));
        ...
        //제한. 20대 이상 성인만 출력
        System.out.println("=".repeat(10) + "성인명단 출력" + "=".repeat(10));
        customerList.stream()
